...
async function main() {
  ...
  const server = http.createServer((_req, res) => {
    ...
    res.end('<!doctype html><title>Huddle Windows smoke</title><h1>Huddle Windows</h1><button onclick="window.open(location.origin + \'/floating\', \'_blank\')">Open floating window</button>')
  })
