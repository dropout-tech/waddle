...
const DESKTOP_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    title: '右上角：使用者選單',
    body: '點開有你的帳號資訊、深淺色切換與登出，還有「📌 顯示便條紙」——開了會出現一片玻璃便條層，貼在畫面上、換頁也不會不見，可以拖曳、選顏色或刪除。桌面上按 ⌘K 隨時召喚指令面板（搜任務、切視圖、開記事本）；按 ? 看完整快捷鍵。',
    placement: 'bottom',
    padding: 4,
  },
  {
...
const MOBILE_STEPS: TourStep[] = [
  ...
  {
    title: '📅 每日簽到 ＆ 會議轉任務',
    body: '日曆頁「⋯」選單裡有「每日簽到」，記錄心情累積連續天數；使用者選單裡有「會議轉任務」，貼上逐字稿自動整理成待辦任務。使用者選單裡也有「📌 顯示便條紙」，開了會出現一片玻璃便條層貼在畫面上，換頁也不會不見。',
  },
  {
    title: '✨ 你準備好了！',
    body: '最後一步：你想怎麼開始？',
