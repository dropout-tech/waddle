...
const DESKTOP_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    title: '右上角：使用者選單',
    body: '點開有你的帳號資訊、深淺色切換與登出。「📌 便條紙」開關現在也在上方工具列（記事本旁邊）就能直接點——開了會出現一片玻璃便條層，貼在畫面上、換頁也不會不見，可以拖曳、選顏色或刪除。桌面上按 ⌘K 隨時召喚指令面板（搜任務、切視圖、開記事本）；按 ? 看完整快捷鍵。',
    placement: 'bottom',
    padding: 4,
  },
  {
  ...
  {
    title: '🤝 指派任務 ＆ 組織',
    body: '打開任務詳情，在「指派給」選一位共享夥伴或同組織成員，這張任務就會同時出現在對方的清單與日曆——對方完成時你這邊立刻看得到。對方也可以附一句理由退回。使用者選單的「指派任務」可以查看進度；Pro 會員還能在「組織」建立團隊、用邀請連結拉成員進來。',
  },
  {
    title: '✨ 你準備好了！',
    body: '最後一步：你想怎麼開始？',
...
const MOBILE_STEPS: TourStep[] = [
  ...
  {
    title: '📅 每日簽到 ＆ 會議轉任務',
    body: '日曆頁「⋯」選單裡有「每日簽到」，記錄心情累積連續天數；使用者選單裡有「會議轉任務」，貼上逐字稿自動整理成待辦任務。「📌 便條紙」開關也在日曆工具列（記事本旁邊）或「⋯」選單裡就能直接點開，開了會出現一片玻璃便條層貼在畫面上，換頁也不會不見。',
  },
  {
    title: '🤝 指派任務 ＆ 組織',
    body: '打開任務詳情，在「指派給」選一位共享夥伴或同組織成員，這張任務就會同時出現在對方的清單與日曆——對方完成時你這邊立刻看得到。對方也可以附一句理由退回。使用者選單的「指派任務」可以查看進度；Pro 會員還能在「組織」建立團隊、用邀請連結拉成員進來。',
