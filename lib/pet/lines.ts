...
export const PET_LINES: PetLine[] = [
  ...group('absurd', [
    ...
    ['如果你聽到嘎嘎聲，那是我在思考。思考很吵。', 'If you hear honking, that\'s me thinking. Thinking is loud.'],
    ...
    ['我剛學會吹口哨，但吹出來是「嘎」。', 'I just learned to whistle. It comes out as "honk."'],
    ...
    ['我在寫一本書，書名叫《我在這裡》，目前寫了一個字：嘎。', 'I\'m writing a book called "I Am Here." So far it has one word: honk.'],
    ...
    ['我在練習講話很有深度：……嘎。', 'I\'m practicing sounding profound: ...honk.'],
  ...
  ...group('work', [
    ...
    ['開會小技巧：如果大家都不說話，就說「嘎」。效果我還在研究。', 'Meeting tip: if everyone\'s silent, say "honk." Results pending.'],
    ...
    ['我幫你把「很忙」翻譯成企鵝語：嘎嘎嘎嘎。', 'I translated "very busy" into Penguin: honk honk honk honk.'],
    ...
    ['我試著幫你回信，但我只會打「嘎」，所以還是你來吧。', 'I tried answering your emails, but I can only type "honk." Over to you.'],
  ...
  ...group('celebrate', [
    ...
    ['嘎！這是企鵝語的「超棒」。', 'Honk! That\'s Penguin for "amazing."'],
  ...
  ...group('meeting', [
    ...
    ['嘎！「{title}」快開始了（{time} 分鐘），我先幫你暖場。', 'Honk! "{title}" is almost here ({time} min). I\'ll warm up the room.'],
  ...
  ...group('poke', [
    ...
    ['嘎！（這是抗議，很有禮貌的那種）', 'Honk! (A very polite protest.)'],
