...
export const metadata: Metadata = { title: '取消訂閱與退款｜Huddle', alternates: { canonical: '/refunds' } }
export default function RefundsPage() {
  return <LegalPage title="取消訂閱與退款" intro="取消續訂、申請退款與刪除帳號是不同的操作。這裡先說明它們的差別與商店官方入口。">
